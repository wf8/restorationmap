<?php
// modified 10/19/2011 for restoration map
// server doesn't have zlib
// removed pear/zlib dependencies
// Archive_Zip objects can be created, files added, other functionality
// may not work without zlib installed on system
